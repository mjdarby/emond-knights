...
### UI CONSTANTS
# Health bar segment statuses
UIHEALTHBARSEGMENT_FILLED   = 0
UIHEALTHBARSEGMENT_UNFILLED = 1
UIHEALTHBARSEGMENT_TOP      = 0
UIHEALTHBARSEGMENT_MIDDLE   = 1
UIHEALTHBARSEGMENT_BOTTOM   = 2